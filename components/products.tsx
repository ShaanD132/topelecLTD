...
const Products: React.FC = () => (
    <div className = "products flex flex-col items-center justify-center" id = "products">
        <p className = "font-latob text-4xl mt-32">Our Products</p>
        <div className = "flex flex-row justify-between px-32 mt-8">
            <div className = "grid gap-x-5 gap-y-10 grid-rows-2 grid-cols-3 items-center w-full auto-rows-min">
                ...
                <div className = "flex flex-row items-center justify-center font-hb"><p className = "text-xl px-24 text-center">Click on each brand to see their catalog</p></div>
                ...
                <div className = "flex flex-row items-center justify-center font-hb"><p className = "text-xl px-24 text-center">Email the list of products needed at jar.lau@intnet.mu*</p></div>
            </div>
        </div>
    </div>
)
