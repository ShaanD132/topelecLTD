        ...
        <div className = "navbar drop-shadow-[0_4px_4px_rgba(0,0,0,0.05)] fixed w-full z-20">
            <div className = "flex justify-between flex-row mx-8 md:mx-20 py-5">
                ...
                <div className = "flex flex-row text-sm md:text-lg xl:text-xl md:mt-2 font-letters">
                    <Link href="/" className = "hover:text-main-yellow cursor-pointer"><h2 className = "mx-2 md:mx-6">Home</h2></Link>
                    <Link  href = "/#services" className = "hover:text-main-yellow cursor-pointer"><p className = "mx-2 md:mx-6">Services</p></Link>
                    <Link  href = "/#products" className = "hover:text-main-yellow cursor-pointer"><p className = "mx-2 md:mx-6">Products</p></Link>
                    <Link  href = "/#projects" className = "hover:text-main-yellow cursor-pointer"><p className = "mx-2 md:mx-6">Projects</p></Link>
                </div>
            </div>
        </div>
    )
