        ...
        <div className = "navbar drop-shadow-[0_4px_4px_rgba(0,0,0,0.05)] fixed w-full z-10">
            <div className = "flex justify-between flex-row mx-8 md:mx-20 py-5">
                ...
                <div className = "flex flex-row text-sm md:text-lg xl:text-xl md:mt-2 font-h">
                    <Link to = "home" spy = {true} smooth = {true} offset = {-10} duration = {1000} className = "hover:text-blu cursor-pointer"><h2 className = "mx-2 md:mx-6">Home</h2></Link>
                    ...
                    <Link  to = "products" spy = {true} smooth = {true} offset = {0} duration = {1000} className = "hover:text-blu cursor-pointer"><p className = "mx-2 md:mx-6">Products</p></Link>
