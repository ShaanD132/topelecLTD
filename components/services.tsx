...
const Services: React.FC = () => (
    <div className = "flex flex-col items-center justify-center" id = "services">
        <p className = "font-latob text-2xl md:text-4xl mt-10 md:mt-14">Services</p>
        <div className = "grid gap-x-5 gap-y-10 lg:gap-x-7 lg:gap-y-0 grid-cols-2 lg:grid-cols-4 items-center w-full auto-rows-min px-10 mt-10 md:mt-16">
